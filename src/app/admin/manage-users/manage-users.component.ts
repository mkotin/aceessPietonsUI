            ...
            (res: any) => {
                if (res.success) {
                    ...
                    if (res.code === 0) {
                        ...
                        Swal.fire({
                            ...
                            position: 'top-end',
                            title: 'Oops...',
                            text: res.message ? res.message : 'Une erreur est survenue! Veuillez contacter l\'administrateur!',
                            showConfirmButton: false,
                            timer: 2000
                        });
                    }
                ...
                if (err.error.code === 0) {
                    ...
                    Swal.fire({
                        ...
                        position: 'top-end',
                        title: 'Oops...',
                        text: err.error.message ? err.error.message : 'Une erreur est survenue! Veuillez contacter l\'administrateur!',
                        showConfirmButton: false,
                        timer: 2000
                    });
                }
